...
Interchange For example uppercase A  65 asterisk   42 and lowercase k  
107
...
locations and without both quothalvesquot it is impossible to decrypt 
the message
...
<a href="project/resources/p059_cipher.txt">ciphertxt</a> right click 
and Save LinkTarget As a file containing the encrypted ASCII codes and 
