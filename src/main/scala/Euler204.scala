...
<var>n</var> if it has no prime factor larger than <var>n</var>
Hence the Hamming numbers are the generalised Hamming numbers of type 
5

How many generalised Hamming numbers of type 100 are there which dont 
exceed 10<sup>9</sup>
*/
object Euler204 extends App {
  println("Euler 204")
}