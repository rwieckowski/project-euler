/**
A positive integer <i>n</i> is divided by <i>d</i> and the quotient 
and remainder are <i>q</i> and <i>r</i> respectively In addition <i>d
</i> <i>q</i> and <i>r</i> are consecutive positive integer terms in a 
...
Some progressive numbers such as 9 and 10404  102<sup>2</sup> happen 
