...
at each step depending on the ants position

At the start of the walk a seed is placed on each square of the lower 
row When the ant isnt carrying a seed and reaches a square of the 
...
Whats the expected number of steps until all seeds have been dropped 
in the top row 
Give your answer rounded to 6 decimal places
*/
object Euler280 extends App {
  println("Euler 280")
}