...
train moves off the turntable pulling the carriages still attached 
...
we shall call <i>maximix arrangements</i> are DACB and DBAC each 
...
he uses for DACB is shown below<div align='center'>
<img src="project/images/p336_maximix.gif" />
*/
object Euler336 extends App {
  println("Euler 336")
}